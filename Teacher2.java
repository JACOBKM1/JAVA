...
// display the data members. Use array of objects to display details of N teachers.
  class Teacher2 extends Employee{
     ...
     String Department;
     int Teacherid;
    Teacher2(String name,String gender,String address, int age,int empid, String company_name, String qualification,double salary, String subject, String department, int teacherid){
